 ...
 */
final class Version20240305160418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, id_client_id INT DEFAULT NULL, id_cat_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, negociable TINYINT(1) NOT NULL, prix DOUBLE PRECISION NOT NULL, status INT DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_CB988C6FA76ED395 (user_id), INDEX IDX_CB988C6F99DED506 (id_client_id), INDEX IDX_CB988C6FC09A1CAE (id_cat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, key_cat INT NOT NULL, nbr_annonce INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prod_r (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, ptc_id_id INT NOT NULL, type_prod_id_id INT NOT NULL, statut TINYINT(1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, nom_p VARCHAR(255) DEFAULT NULL, justificatif VARCHAR(255) NOT NULL, last_update DATE DEFAULT NULL, INDEX IDX_9641CAEF9D86650F (user_id_id), INDEX IDX_9641CAEFC050CD01 (ptc_id_id), INDEX IDX_9641CAEFE419D911 (type_prod_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
