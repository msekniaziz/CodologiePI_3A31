...
public function index11(Request $request): Response
{
    ...
    #[Route('/edit/{idprd}', name: 'app_produit_troc_edit', methods: ['GET', 'POST'])]
    public function edit($idprd,Request $request, ProduitTroc $produitTroc, EntityManagerInterface $entityManager): Response
    {
